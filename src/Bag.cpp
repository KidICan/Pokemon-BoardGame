...
string Bag::InsideBag(BagState tri)
{
    ...
    cout << "---------------------------------------------" << endl;
    cout << "Do you want view your items  or do you want to see your pokemon stats? " << endl;
    cout << "Please select the option you would like" << endl;
    cout << "---------------------------------------------" << endl;
    cout << "1. View Pokemon Stats" << endl;
    cout << "2. View or use Items" << endl;
    cout << "0. Leave Bag"<<endl;
    cin >> opt;
    ...
    else
    {
        if (tri == BagState::Main)
        {
            ...
            while (notLeft)
            {
                ...
                for (it = Items.begin(); it != Items.end(); it++)
                {
                    if ((((tri == BagState::Main || tri == BagState::Trainer) && repo.dItem[it->first].getType() == ItemType::Heal) || (tri == BagState::Wild)) && it->second > 0)
                    {
                        counter++;
